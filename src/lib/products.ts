...
export const products: Product[] = [
  ...
  { id: 'portfolioai', name: 'PortfolioAI', tagline: 'Stunning portfolios in seconds', description: 'AI-powered portfolio website generator', category: 'Standalone Tools', url: 'https://portfolioai-n2eyrgpo1-lucasye378-9140s-projects.vercel.app', color: '#6366f1', icon: '🖼️' },
